...
interface RepositoryDao {
    ...
    @Query("SELECT distinct contributor.login, contributor.avatar_url from contributor inner join repository on repository.login == :user")
    fun selectContributorsOfUsersRepositories(user: String?): List<Contributor>
